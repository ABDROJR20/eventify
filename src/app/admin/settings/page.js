          ...
          <Card className="flex-1 rounded-[2.5rem] shadow-xl dark:shadow-none border-none dark:border dark:border-slate-800 bg-white dark:bg-slate-900 p-6 sm:p-10 transition-colors duration-300">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-3 border-t border-slate-100 dark:border-slate-850 pt-8">
                <label className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Minimum Withdrawal Amount ($)</label>
                <Input defaultValue="50.00" type="number" className="h-14 bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-855 font-bold text-slate-900 dark:text-white text-lg rounded-xl focus:ring-2 focus:ring-brand-blue" />
            ...
            <div className="p-6 bg-rose-50 dark:bg-rose-950/20 rounded-[1.5rem] border border-rose-100 dark:border-rose-900 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-colors duration-300">
              <div>
                <h4 className="font-black text-rose-600 dark:text-rose-400 text-lg">Maintenance Mode</h4>
                <p className="text-sm font-bold text-rose-500/70 dark:text-rose-455">Locks out all users except Super Admins. Shows maintenance page.</p>
              </div>
              <Button variant="outline" className="border-rose-200 dark:border-rose-900 text-rose-600 dark:text-rose-400 font-bold hover:bg-rose-100 dark:hover:bg-rose-950/40 rounded-xl px-6 h-11 shrink-0 w-full sm:w-auto justify-center">
                Enable Maintenance
              </Button>
            </div>
          </Card>
...
function SettingsTab({ icon, label, active = false }) {
  return (
    <div className={`flex items-center gap-4 px-6 py-4 rounded-[1.25rem] cursor-pointer transition-all font-black text-sm tracking-tight ${
      active 
